          ...
          >
            ...
            {availableRoles.length > 0 ? (
              <div className="col-span-6 lg:col-span-4">
                ...
                <div className="relative z-0 mt-1 border border-slate-200 rounded-lg cursor-pointer">
                  {availableRoles.map((role, i) => (
                    <button
                      type="button"
                      className={classNames(
                        'relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-slate-300 focus:ring focus:ring-slate-200',
                        {
                          'border-t border-slate-200 rounded-t-none': i > 0,
                          'rounded-b-none':
            ...
            <div className="space-y-6">
              {team.team_invitations.map(invitation => (
                <div
                  ...
                  key={invitation.id}
                >
                  <div className="text-slate-600">{invitation.email}</div>
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    availableRoles.length ? (
                      <button
                        className="ml-2 text-sm text-slate-400 underline"
